...
public class NawaitAcesActivity extends AppCompatActivity {

    private static final String TAG = "NawaitAcesActivity";
    ...
    protected void onCreate( final Bundle savedInstanceState) {
        ...
        mStoriesDatabaseReference =mFirebaseDatabase.getReference().child("aces");
        mStoriesStorageReference =firebaseStorage.getReference().child("aces_team");
        Button =(ImageView) findViewById(R.id.backButton);

        Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(NawaitAcesActivity.this,Teams.class);
                startActivity(i);
                finish();
            }
        });
        ...
        Query mHouseDatabaseReference2 =mFirebaseDatabase.getReference().child("aces");
        ...
        mHouseDatabaseReference2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new TeamAdapter(NawaitAcesActivity.this, getmMatch());
        ...
        mAuthStateListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    adapter = new TeamAdapter(NawaitAcesActivity.this, images);

...
public class NawaitSultanActivity extends AppCompatActivity {

    private static final String TAG = "NawaitSultanActivity";
    ...
    protected void onCreate( final Bundle savedInstanceState) {
        ...
        mStoriesDatabaseReference =mFirebaseDatabase.getReference().child("sultan");
        mStoriesStorageReference =firebaseStorage.getReference().child("sultan_team");
        Button =(ImageView) findViewById(R.id.backButton);

        Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(NawaitSultanActivity.this,Teams.class);
                startActivity(i);
                finish();
            }
        });
        ...
        Query mHouseDatabaseReference2 =mFirebaseDatabase.getReference().child("sultan");
        ...
        mHouseDatabaseReference2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new TeamAdapter(NawaitSultanActivity.this, getmMatch());
        ...
        mAuthStateListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    adapter = new TeamAdapter(NawaitSultanActivity.this, images);

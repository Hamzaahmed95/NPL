...
public class NawaitUnitedActivity extends AppCompatActivity {

    private static final String TAG = "NawaitUnitedActivity";
    ...
    protected void onCreate( final Bundle savedInstanceState) {
        ...
        mStoriesDatabaseReference =mFirebaseDatabase.getReference().child("united");
        mStoriesStorageReference =firebaseStorage.getReference().child("united_team");
        Button =(ImageView) findViewById(R.id.backButton);

        Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(NawaitUnitedActivity.this,Teams.class);
                startActivity(i);
                finish();
            }
        });
        ...
        Query mHouseDatabaseReference2 =mFirebaseDatabase.getReference().child("united");
        ...
        mHouseDatabaseReference2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new TeamAdapter(NawaitUnitedActivity.this, getmMatch());
        ...
        mAuthStateListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    adapter = new TeamAdapter(NawaitUnitedActivity.this, images);

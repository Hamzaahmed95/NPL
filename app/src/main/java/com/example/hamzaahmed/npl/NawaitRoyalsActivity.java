...
public class NawaitRoyalsActivity extends AppCompatActivity {

    private static final String TAG = "NawaitRoyalsActivity";
    ...
    protected void onCreate( final Bundle savedInstanceState) {
        ...
        mStoriesDatabaseReference =mFirebaseDatabase.getReference().child("royals");
        mStoriesStorageReference =firebaseStorage.getReference().child("royals_team");
        Button =(ImageView) findViewById(R.id.backButton);

        Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(NawaitRoyalsActivity.this,Teams.class);
                startActivity(i);
                finish();
            }
        });
        ...
        Query mHouseDatabaseReference2 =mFirebaseDatabase.getReference().child("royals");
        ...
        mHouseDatabaseReference2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new TeamAdapter(NawaitRoyalsActivity.this, getmMatch());
        ...
        mAuthStateListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    adapter = new TeamAdapter(NawaitRoyalsActivity.this, images);

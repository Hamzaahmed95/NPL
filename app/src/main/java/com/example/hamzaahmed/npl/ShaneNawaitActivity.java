...
public class ShaneNawaitActivity extends AppCompatActivity {
    ...
    protected void onCreate( final Bundle savedInstanceState) {
        ...
        mStoriesDatabaseReference =mFirebaseDatabase.getReference().child("shan");
        mStoriesStorageReference =firebaseStorage.getReference().child("shan_team");
        Button =(ImageView) findViewById(R.id.backButton);

        Button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(ShaneNawaitActivity.this,Teams.class);
                startActivity(i);
                finish();
            }
        });
        ...
        Query mHouseDatabaseReference2 =mFirebaseDatabase.getReference().child("shan");
        ...
        mHouseDatabaseReference2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapter = new TeamAdapter(ShaneNawaitActivity.this, getmMatch());
        ...
        mAuthStateListner = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    adapter = new TeamAdapter(ShaneNawaitActivity.this, images);

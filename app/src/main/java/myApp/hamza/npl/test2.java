...
public class test2  extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        PointsTableStorageReference =firebaseStorage.getReference().child("top3_Ocaps1");
        mMessageDatabaseReference =mFirebaseDatabase.getReference().child("top3Ocaps1");
        PointsTableStorageReference2 =firebaseStorage.getReference().child("top3_Ocaps2");
        mMessageDatabaseReference2 =mFirebaseDatabase.getReference().child("top3Ocaps2");
        PointsTableStorageReference3 =firebaseStorage.getReference().child("top3_Ocaps3");
        mMessageDatabaseReference3 =mFirebaseDatabase.getReference().child("top3Ocaps3");
        PointsTableStorageReference4 =firebaseStorage.getReference().child("top3_Ocaps4");
        mMessageDatabaseReference4 =mFirebaseDatabase.getReference().child("top3Ocaps4");
        PointsTableStorageReference5 =firebaseStorage.getReference().child("top3_Ocaps5");
        mMessageDatabaseReference5 =mFirebaseDatabase.getReference().child("top3Ocaps5");
        PointsTableStorageReference6 =firebaseStorage.getReference().child("top3_Ocaps6");
        mMessageDatabaseReference6 =mFirebaseDatabase.getReference().child("top3Ocaps6");
        ...
        Query mHouseDatabaseReference1 =mFirebaseDatabase.getReference().child("top3Ocaps1").limitToLast(1);;
        ...
        Query mHouseDatabaseReference2 =mFirebaseDatabase.getReference().child("top3Ocaps2").limitToLast(1);;
        ...
        Query mHouseDatabaseReference3 =mFirebaseDatabase.getReference().child("top3Ocaps3").limitToLast(1);;
        ...
        Query mHouseDatabaseReference4 =mFirebaseDatabase.getReference().child("top3Ocaps4").limitToLast(1);;
        ...
        Query mHouseDatabaseReference5 =mFirebaseDatabase.getReference().child("top3Ocaps5").limitToLast(1);;
        ...
        Query mHouseDatabaseReference6 =mFirebaseDatabase.getReference().child("top3Ocaps6").limitToLast(1);;
